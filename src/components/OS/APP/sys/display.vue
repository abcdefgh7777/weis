  ...
  <div class="app-sys-display-box">
    ...
    <div class="right-box">
      <transition-group name="modeTransition">
        <div v-if="activeMode === 'Basic'" class="mode-item mode-basic">
          <div class="mode-name">
            {{ activeMode }}
          </div>
          ...
          <div class="options-box">
            ...
            >
              ...
              <div class="options-name">Default Wallpaper</div>
            </div>
            ...
            >
              <div class="preview-box">
                <Fg-Image
                  :src="bingRandomUrl"
                  alt="Bing random wallpaper"
                />
              </div>

              <div class="options-name">Random Wallpaper</div>
            </div>
          </div>

          <div class="options-description">
            <p>Default: Built-in interactive wallpaper component</p>
            <p>
              Random: Fetched from a third-party API, changes on each page refresh with Bing wallpapers
              <a :href="randomUrl" target="_blank">{{ randomUrl }}</a>
            </p>
          </div>
        </div>

        <div v-if="activeMode === 'Color'" class="mode-item mode-color">
        ...
        <div v-else-if="activeMode === 'Bing'" class="mode-item mode-bing">
          <div class="mode-name">
            {{ activeMode }}
            <span class="name-description">
              Bing updates a wallpaper daily, showing recent ones here
            </span>
          </div>
          ...
          <div class="image-list">
            <div
              ...
              :key="index"
            >
              <Fg-Image :src="jointBingUrl(item.url)" alt="Bing wallpaper" />
            </div>
          </div>
        </div>

        <div v-else-if="activeMode === 'Custom'" class="mode-item mode-self">
          <div class="mode-name">{{ activeMode }}</div>
...
const modes = ["Basic", "Color", "Bing", "Custom"];
...
.app-sys-display-box {
  ...
  .right-box {
    ...
    .image-box {
      ...
      &::after {
        content: "Click to set wallpaper";
